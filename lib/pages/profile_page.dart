...
import 'package:mylog/pages/login_page.dart';
import 'package:mylog/pages/splash_screen.dart';
import 'package:mylog/pages/widgets/header_widget.dart';
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const Text('Mr. Kelin Ablorh', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
                  const SizedBox(height: 20,),
                  const Text('Ghanaian', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                                    ...
                                    ...ListTile.divideTiles(
                                      ...
                                      tiles: [
                                        ...
                                        const ListTile(
                                          ...
                                          title: Text("Email"),
                                          subtitle: Text("Kelin@gmail.com"),
                                        ),
                                        const ListTile(
                                          leading: Icon(Icons.phone),
                                          title: Text("Phone"),
                                          subtitle: Text("020 020 0202"),
                                        ),
                                        const ListTile(
